...
func (c *greeterService) Hello(ctx context.Context, in *proto1.Request, opts ...client.CallOption) (*proto1.Response, error) {
...
func (h *greeterHandler) Hello(ctx context.Context, in *proto1.Request, out *proto1.Response) error {
